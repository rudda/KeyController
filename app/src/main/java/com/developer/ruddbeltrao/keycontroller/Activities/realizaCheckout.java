...
/**
 * Created by Dev Rudda - Lab 312 - ICET/UFAM on 18/12/2015 as 11:04
 * contact : beltrao.rudah@gmail.com
 */
public class realizaCheckout   extends ActionBarActivity implements DatePickerDialog.OnDateSetListener, DialogInterface.OnCancelListener, AdapterView.OnItemSelectedListener {
...
private ListView mListCheck;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            adapter = new AdapterCheck(realizaCheckout.this, mChecks);
            ...
            ButtondatePicket.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    DatePickerDialog date = DatePickerDialog.newInstance(realizaCheckout.this, mCalendar.get(Calendar.YEAR),
                    ...
                    date.setOnCancelListener(realizaCheckout.this);
            ...
            seach.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (data.getText() != null & data.getText().toString().length() > 0) {
                        ...
                        mChecks = mData.testCk(myDate , false, mSipnnerLab.getSelectedItem().toString());

                        Toast.makeText(realizaCheckout.this, "size " + mChecks.size(), Toast.LENGTH_SHORT).show();
                        adapter = new AdapterCheck(realizaCheckout.this, mChecks);
